...
import { getHistoricalCoverageKpis } from '../../services/coverageService';
...
const CoverageStackedArea = ({ coverages }) => {
    ...
    return (
        <React.Fragment>
            ...
            <AreaChart width={960} height={400} data={sorted} syncId="covLineArea" margin={{ top: 30, right: 30, left: 0, bottom: 0 }}>
                <CartesianGrid strokeDasharray="1 2" />
                <XAxis
                ...
                <Area type="linear" name="On hold" dataKey="onHoldRatio" stackId="1" stroke="#d28846" fill="#d28846" />
                <Area type="linear" name="In Progress" dataKey="inProgressRatio" stackId="1" stroke="#666666" fill="#b3b3b3" />
                <Area type="linear" name="Open" dataKey="openRatio" stackId="1" stroke="#aaaaaa" fill="#e3e3e3" />
                <Brush />
            </AreaChart>
        </React.Fragment>
    );
